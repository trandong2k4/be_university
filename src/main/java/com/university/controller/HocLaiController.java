...
// import com.university.dto.response.HocLaiResponseDTO;

// import jakarta.validation.Valid;
import lombok.RequiredArgsConstructor;

@RestController
@RequestMapping("/makeup_courses")
...
public class HocLaiController {
    ...
    // @PostMapping
    // public ResponseEntity<HocLaiResponseDTO> create(@RequestBody @Valid
    // HocLaiRequestDTO dto) {
    // return
    // ResponseEntity.status(HttpStatus.CREATED).body(hocLaiService.create(dto));
    // }
    ...
    // @GetMapping("/search")
    // public ResponseEntity<List<HocLaiResponseDTO>> search(@RequestParam String
    // keyword) {
    // return ResponseEntity.ok(hocLaiService.search(keyword));
    // }

    // @PutMapping("/{id}")
    // public ResponseEntity<HocLaiResponseDTO> update(@PathVariable UUID id,
    // @RequestBody @Valid HocLaiRequestDTO dto) {
